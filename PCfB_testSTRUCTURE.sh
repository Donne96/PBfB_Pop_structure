...
do 
structure -m /PBfB_Pop_structure/mainparams -e /PBfB_Pop_structure_extraparams -i /PBfB_Pop_structure/WS_struc_msat.txt -K ${k} -o /PBfB_Pop_structure/Results_WSPopstruc/outfile_k${k}_rep${rep}
done
done
